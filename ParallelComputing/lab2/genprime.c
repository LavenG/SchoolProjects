...
int main(int argc, char *argv[]){
  //two integeres to read in the command line input
  int t;
  int N;
  ...
  //Initialize an array to contain the prime numbers
  ...
  //With multiple threads divide the work between the two for loops
    ...
    tstart = omp_get_wtime();
    //Divide the work of the outer and inner loop among threads equally
  ...
  //Output the execution time of the main part
