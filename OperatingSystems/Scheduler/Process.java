...
public class Process {
	...
	// used to keep track of the initial running time in order to set the
	// correct block time
	private int initialRunningTime;
	...
	// getter and setter methods for process data fields
	...
	public void setInitialRunningTime(int i) {
		this.initialRunningTime = i;
	}

	public int getInitialRunningTime() {
		return this.initialRunningTime;
	}

	// used to increment time data fields for a single process
	...
	// Used to determine if a currently running process should be still running
	// or not
	...
	// used to determine if a process should be still blocked or not
	...
	public String toString() {
		return "(" + this.getArrivalTime() + " " + this.getCPUBurstTime() + " " + this.getTotalCPUTime() + " "
				+ this.getIOBurstTime() + ")";
	}

	public String alternateToString() {
		return "(" + this.getArrivalTime() + "," + this.getCPUBurstTime() + "," + this.getUnmodifiedTotalCPUTime() + ","
				+ this.getIOBurstTime() + ")";
	}
